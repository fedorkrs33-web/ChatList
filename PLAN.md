...
chatlist/ ├── main.py # Точка входа, GUI ├── db.py # Работа с SQLite ├── models.py # Управление моделями ├── network.py # Запросы к API ├── config.py # Загрузка .env └── .env # API-ключи
...
- Обработка разных типов API (OpenAI-совместимые)
